    ...
    <div class="box d-flex justify-content-center align-items-center">
        ...
        <div class="position-absolute">
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Berhasil!</strong><br /> {{ session()->get('failed') }}.
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        </div>
        @elseif ($errors->any())
        ...
        <form action="{{ route('login') }}" method="post" class="form w-50">
            @csrf
            <h2 class="py-4 text-center">Login Bagi Kisah</h2>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-outline-primary fw-semibold mt-4 mb-2">Login</button>
        </form>
    </div>
