...
<body>
    <nav class="navbar bg-body-tertiary z-3">
        <div class="container">
            <a class="navbar-brand nav-text fw-semibold" href="#">Edit Cerita</a>
    ...
    <div class="box d-flex justify-content-center align-items-center">
        ...
        <form action="{{ route('login') }}" method="post" class="form w-50">
            @csrf
            <h2 class="py-4 text-center">Edit Cerita</h2>
            <div class="mb-3">
            ...
            <button type="submit" class="btn btn-outline-primary fw-semibold mt-4 mb-2">Simpan Perubahan</button>
        </form>
    </div>
